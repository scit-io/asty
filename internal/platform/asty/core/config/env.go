...
func applyGatewayEnv(g *GatewayConfig) {
	...
	envStr("A_GATEWAY_AUTH_RATE_PREFIX", &g.RateLimit.AuthPathPrefix)
	envFloat("A_GATEWAY_AUTH_RATE_LIMIT", &g.RateLimit.AuthRate)
	envInt("A_GATEWAY_AUTH_RATE_BURST", &g.RateLimit.AuthBurst)
