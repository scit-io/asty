...
Этот документ — собрание соглашений по написанию кода в пакете Asty. Они сформировались в ходе рефакторинга Phase 6. Если ты только начинаешь, прочти его целиком — после этого код Asty будет читаться как книжка с понятными именами и комментариями «зачем».
